...
public class StudentServiceImplServiceLocator extends org.apache.axis.client.Service implements com.unilib.service.StudentServiceImplService {
    ...
    private java.lang.String StudentServiceImpl_address = "http://localhost:8080/UniLib/services/StudentServiceImpl";
    ...
    public com.unilib.service.StudentServiceImpl getStudentServiceImpl(java.net.URL portAddress) throws javax.xml.rpc.ServiceException {
        try {
            com.unilib.service.StudentServiceImplSoapBindingStub _stub = new com.unilib.service.StudentServiceImplSoapBindingStub(portAddress, this);
    ...
    public java.rmi.Remote getPort(Class serviceEndpointInterface) throws javax.xml.rpc.ServiceException {
        try {
            if (com.unilib.service.StudentServiceImpl.class.isAssignableFrom(serviceEndpointInterface)) {
                com.unilib.service.StudentServiceImplSoapBindingStub _stub = new com.unilib.service.StudentServiceImplSoapBindingStub(new java.net.URL(StudentServiceImpl_address), this);
                _stub.setPortName(getStudentServiceImplWSDDServiceName());
                return _stub;
            }
        }
    ...
    public javax.xml.namespace.QName getServiceName() {
        return new javax.xml.namespace.QName("http://service.unilib.com", "StudentServiceImplService");
    }
    ...
    public java.util.Iterator getPorts() {
        if (ports == null) {
            ...
            ports.add(new javax.xml.namespace.QName("http://service.unilib.com", "StudentServiceImpl"));
        }
